    ...
    <div class="p-8 flex items-start bg-light-grey rounded-md shadow-lg">
      ...
      <form @submit.prevent="createWorkout" class="flex flex-col gap-y-5 w-full">
        ...
        <div v-if="workoutType === 'strength'" class="flex flex-col gap-y-4">
          ...
          <button @click="addExercise" type="submit" class="mt-6 py-2 px-6 rounded-sm self-start text-sm text-white bg-at-light-green duration-200 border-solid border-2 border-transparent hover:border-at-light-green hover:bg-white hover:text-at-light-green">Add Exercise</button>
        </div>
